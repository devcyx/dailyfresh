    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', blank=True, verbose_name='groups', to='auth.Group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_default', models.CharField(verbose_name='邮政编码', null=True, max_length=6)),
